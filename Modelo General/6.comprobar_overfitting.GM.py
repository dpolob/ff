...
def main(dataset_train, dataset_validation, mmscaler, modelo='B', batch_size=100, num_epoch=50, p_dropout=0.5):
    writer = SummaryWriter('selected/' + modelo + '_' + str(batch_size) + '_' + str(num_epoch) + '_' + str(p_dropout))
    ...
    for x_test, y_test in test_dataloader:
        ...
        print("Batch: %6d Loss: %2.8f ErrorMean: %2.8f" %(batch, loss.item(), (y_pred_test - y_test).mean()))
